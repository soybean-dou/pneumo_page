...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description = "Pre-processing for Pneumoniae analysis Using FastQC, Cutadapt, Sickle",
            epilog = "Parameter 1: read1, 2: read2, 3: QS, 4: Trimmed Length, 5: Human reference genome, 6: Custom reference genome, 7: Output DIR")
...
#    AdapterseqRev = args.Reverse_Adapter_sequence
    ...
    workpath = os.path.join(result_dir,jobname,"workpath")
